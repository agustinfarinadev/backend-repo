...
This backend app is paired with a frontend, exemplified [here](https://github.com/agustinfarinadev/frontend-repo).
...
```
[{"id":"1b6f431e-b26a-459f-8677-3a82cdd670be","name":"Agustin Farina"},{"id":"41c36348-4f09-45ee-9b99-8feee475688e","name":"Elvia Riyani"}]
```
...
```
{"id":"1b6f431e-b26a-459f-8677-3a82cdd670be","name":"Agustin Farina"}
```
#### Updating a user
You need to pass the `id` of the user. Using the example above, you can call it like this:
```
